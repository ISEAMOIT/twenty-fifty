...
class TestModel < Minitest::Unit::TestCase
  ...
  def test_control_i6; assert_equal("Most electricity will come from coal. Total electricity generation will reach 1514TWh in 2050 from coal-fired power plants. Total installed capacity will be 278.6 TW in 2050", worksheet.control_i6.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_j6; assert_equal("Electricity generated from coal in 2050 will be reduced and reached only 1151 TWh. All alternatives came from RE and Nuclear power sources. Total installed capacity will be 215.7 TW in 2050", worksheet.control_j6.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_k6; assert_equal("Reduction of coal power plants is stronger. Total generation of 1049 TWh in 2050. Total installed capacity will be 191.4 TW in 2050", worksheet.control_k6.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_l6; assert_equal("Assumes a reduction of coal power plants is highest. The electricity generation of  94.91 TWh in 2050. Total installed capacity will be  171.7 TW in 2050", worksheet.control_l6.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_i7; assert_equal("New technology development/deployment will be slow. In 2050, there is only 1.3% of Super Critical technology installed. The remaining coal power plants are Sub-Critical power plants. ", worksheet.control_i7.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_j7; assert_equal("New technology development/deployment will be slightly faster. The penetration of SC and USC coal power plants expected at 6.9% in 2050.", worksheet.control_j7.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_k7; assert_equal("New technology development/deployment will be encouraged and hence its adoption would be faster. The penetration of SC and USC coal power plants expected at 18.7% in 2050", worksheet.control_k7.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_l7; assert_equal("New technology development/deployment will be aggressively promoted. The penetration of SC and USC coal power plants expected at 37.9% in 2050.", worksheet.control_l7.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_i8; assert_equal("No planned generation plant with CCS until 2050. ", worksheet.control_i8.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_j8; assert_equal("CCS-equipped capacity is expected to grow with capacity demonstration of 600MW - coal & post based by 2050.", worksheet.control_j8.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_k8; assert_equal("More generation plants with CCS technology will be deployed, increasing to 2400MW by 2050.", worksheet.control_k8.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_i9; assert_equal("First units of the plant under planned (by 2020) will be postponed until in 2030 with the capacity are completed and commissioned as of 4000MW. No change until 2050.", worksheet.control_i9.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_j9; assert_equal("Assumes that additional plants will be developed after 2030 to reach 12600 MW by 2050. ", worksheet.control_j9.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_k9; assert_equal("Assumes that 17000 MW will be installed by 2050. ", worksheet.control_k9.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_l9; assert_equal("This assumes that some new sites are identified, which can accommodate about 22000 MW by 2050. ", worksheet.control_l9.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_i10; assert_equal("Capacity addition would be slower rate. Capacity would increase to 252.5MW by 2050. ", worksheet.control_i10.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_j10; assert_equal("Assumes that the capacity addition would follow the revised PDP VII trajectories. Reaches a capacity of  3770 MW by 2030. And assume that reaches a capacity of  7000 MW by 2050  ", worksheet.control_j10.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_k10; assert_equal("Capacity addition in this highly optimistic scenario, to be slightly higher than the revised PDP VII. It would reach 5384 MW by 2030.  And assume that reaches a capacity of  7000 MW by 2050  ", worksheet.control_k10.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_l10; assert_equal("There is absolutely no barrier (economic, social or technical) to the growth of onshore wind power. it reaches 13884 MW by 2050.", worksheet.control_l10.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_i11; assert_equal("Due to higher cost and barriers, especially with regard to development planning and FIT. Not any capacity installed for this level.  ", worksheet.control_i11.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_j11; assert_equal("With the improvement in potential, offshore site identification and cost reductions,  Only demonstration off shore wind farm will be built (200MW by 2050)", worksheet.control_j11.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_k11; assert_equal("Some barriers removes, and not face economic or physical constraints. The development period will be set -up. Capacity addition reaches 1100MW by 2050. ", worksheet.control_k11.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_i12; assert_equal("Due to low FIT, the capacity addition would be slower growth. Capacity would increase to only 164 GW by 2050. ", worksheet.control_i12.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_j12; assert_equal("Assumes that the capacity addition would follow the the revised PDP VII. Reaches a capacity of  299 MW by 2030. And assume that reaches a capacity of  699 MW by 2050 ", worksheet.control_j12.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_k12; assert_equal("Capacity addition in this highly scenario, to be slightly higher than the PDP VII requirements. It would reach 816 MW by 2030.  And assume that reaches a capacity of  1216 MW by 2050  ", worksheet.control_k12.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_l12; assert_equal("There is absolutely no barrier (economic, social or technical) to the growth of onshore wind power. it reaches 1466 MW by 2050.", worksheet.control_l12.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_i13; assert_equal("Due to the environment issues in term of hot development. Development plan will be reviewed. 3000 MW; 4500 MW and 5500 MW will be installed by 2020; 2030 and 2050, respectively", worksheet.control_i13.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_j13; assert_equal("Capacity addition slight increase and reaches the ultimate capacity of 6100 MW by 2050. ", worksheet.control_j13.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_k13; assert_equal("Capacity addition slight increase and reaches the ultimate capacity of 6900MW by 2050", worksheet.control_k13.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_l13; assert_equal("Capacity addition reaches the capacity of 7800MW by 2050", worksheet.control_l13.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_i14; assert_equal("Due to higher cost and barriers, especially with regard to development planning and FIT. Not any capacity installed for this level", worksheet.control_i14.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_j14; assert_equal("Assumes that CSP costs come down significantly and that there are no limitations on plant size. However only small demonstration sites will be demonstrated (400MW by 2050).", worksheet.control_j14.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_k14; assert_equal("Some barriers removes, and not face economic or physical constraints. The development period will be set -up. Capacity addition reaches 900MW by 2050.", worksheet.control_k14.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_i15; assert_equal("Due to higher cost and barriers, especially with regard to development planning and and no FIT set. Not any capacity installed for this level.  ", worksheet.control_i15.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_j15; assert_equal("Small improvements in technology and and potential assessment. 100 MW will be commissioned by 2050", worksheet.control_j15.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_k15; assert_equal("With the improvement in potential, some good sites identified and cost reduced. Capacity addition will reaches 250MW by 2050", worksheet.control_k15.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_l15; assert_equal("Some barriers removes, and not face constraints. The development will reaches the identified. Capacity reaches 330MW by 2050. ", worksheet.control_l15.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_i16; assert_equal("Due to higher cost and barriers, especially with regard to development planning, no site found and no FIT. So that there is not any capacity installed for this level.  ", worksheet.control_i16.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_j16; assert_equal("Capacity demonstration will be 50 MW by 2050", worksheet.control_j16.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_k16; assert_equal("Some barriers removes, some potential sites identified. Capacity addition reaches 200 MW by 2050. ", worksheet.control_k16.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_i18; assert_equal("Capacity addition would be at slow rate as expected although large biomass potential. Capacity would only increase to 190.5 MW by 2030 and 390 MW by 2050. ", worksheet.control_i18.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_j18; assert_equal("Assumes that the capacity addition would follow the revised PDP VII. Reaches a capacity of  1680 MW by 2030. And assume that reaches a capacity of  2980 MW by 2050  ", worksheet.control_j18.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_k18; assert_equal("Capacity addition in this highly optimistic scenario, to be slightly higher requirements. It would reach  2000 MW by 2030.  And assume that reaches a capacity of  4300 MW by 2050  ", worksheet.control_k18.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_l18; assert_equal("There is absolutely no barrier on economic, technology to the growth of biomass power. It reaches 5780MW by 2050.", worksheet.control_l18.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_i19; assert_equal("Due to higher cost and barriers, especially with regard to development planning. Capacity addition would be developed too slow. Capacity would only increase to 5MW by 2030, peak at 9 MW in 2050.", worksheet.control_i19.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_j19; assert_equal("Capacity addition would follow the revised PDP 7. Capacity addition increases strongly thereafter culminating in a cumulative capacity of 340 MW by 2050. ", worksheet.control_j19.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_k19; assert_equal("Subside for fossil (e.g. coal) price will be removed. The capacity reach 480MW by 2050. ", worksheet.control_k19.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_l19; assert_equal("Barriers will be removed. Reaches capacity of 567MW by 2050.", worksheet.control_l19.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_i20; assert_equal("Capacity addition would be at slow rate. Capacity would increase to 30.4MW by 2050 for land fill and 14 MW for incineration", worksheet.control_i20.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_j20; assert_equal("Reaches a capacity of  64.4MW by 2030 for landfill and 18 MW for incineration. And assume that reaches a capacity of  242.4MW and 108 MW by 2050 for landfill and incineration, respectively  ", worksheet.control_j20.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_k20; assert_equal("It would reach  97.4MW for landfill and 37 MW for incineration by 2030 for .  And assume that reaches a capacity of  297.4 MW and 192 MW by 2050 for landfill and incineration, respectively  ", worksheet.control_k20.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_l20; assert_equal("There is absolutely no barrier. It reaches 417.4MW and 277 MW for landfill and incineration by 2050.", worksheet.control_l20.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_i21; assert_equal("Due to higher cost, especially with regard to planning. Solar PV capacity addition would be developed too slow. Capacity would only increase to 7.5MW by 2030, peak at 22.5MW in 2050.", worksheet.control_i21.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_j21; assert_equal("Capacity addition would follow the revised PDP 7. Capacity addition increases strongly thereafter culminating in a cumulative capacity of 1055 MW by 2030 and 6755 MW by 2050. ", worksheet.control_j21.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_k21; assert_equal("Steady drop in solar PV prices, marginal increase in fossil fuels prices, subside for coal price removed. The capacity PV reach 9174 MW by 2050. ", worksheet.control_k21.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_l21; assert_equal("In this scenario, there is absolutely no barrier (economic, social or technical) to the growth of solar PV. Reaches capacity of 13740 MW by 2050.", worksheet.control_l21.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_i22; assert_equal("Imports continue to be low. This is opportunities for domestic power generation. ", worksheet.control_i22.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_j22; assert_equal("Assumes imports continue. But there is only small change. It keeps as PDP 7   ", worksheet.control_j22.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_k22; assert_equal("It remains constant. ", worksheet.control_k22.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_l22; assert_equal("Promotion for interconnection with ASEAN member countries will be developed as planned", worksheet.control_l22.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_i25; assert_equal("Total domestic passenger demand of the country will reach to 1400 billion passenger kilometers (BPKM)   and distance travelled annually per person is expected to increase to 13,000 km by 2050. ", worksheet.control_i25.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_j25; assert_equal("Total domestic passenger demand of the country will reach to 1300 BPKM   and distance travelled annually per person is droped to 11,800 km by  2050.", worksheet.control_j25.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_k25; assert_equal("Total domestic passenger demand of the country will reach to 1200 BPKM   and distance travelled annually per person is droped to 11,000 km by  2050.", worksheet.control_k25.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_l25; assert_equal("Growth of passenger transport demand would be moderated by conscious policy initiatives on urbanization patterns and management. The total  will reach to 1100 BPKM  and  per capita is 10,000 km by  2050.", worksheet.control_l25.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_i26; assert_equal("No EV penetration for buses, for 2 wheelers and others. No efforts for improvement in fuel efficiency in the transport sector", worksheet.control_i26.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_j26; assert_equal("  EV penetration for buses is 5%, for cars 4% , 1% for the 2 wheelers, rail 9%. Technology efficiences Improvement every year (%) for private cars and 2-W is 0.2% and for others is 0.1%.", worksheet.control_j26.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_k26; assert_equal(" EV penetration for buses is 8%, for cars 6% , 3% for the 2 wheelers, rail 13%. Technology efficiences Improvement every year (%) for private cars and 2-W is 0.4% and for others is 0.2%.", worksheet.control_k26.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_l26; assert_equal("EV penetration for buses is 28%, for cars is 14%, and for 2 wheelers is 17 and  for rail is 35%. Technology efficiences Improvement every year (%) for private cars and 2-W is 0.8% and for others is 0.5%", worksheet.control_l26.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_i28; assert_equal(" Total freight demand will reach 1,600 billion tone kilometers (BTKM) by 2050. ", worksheet.control_i28.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_j28; assert_equal("Thank to a bit direct transportation, good size reduced,  efficiency logistics the total  freight demand is reduced but not much. It will  be 1,588 BTKM by 2050 ", worksheet.control_j28.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_k28; assert_equal(" Total volume of freight  is redduced about 8-9% and reach 1486 BTKM by 2050 due to planned industrial clusters along with optimized transport logistics ...", worksheet.control_k28.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_l28; assert_equal("Concentrated economic activity in the form of logistics parks, industrial centers, informatics, reform.. would result in reduction in the  freight transport  and it  falls to 1300 BTKM by 2050. ", worksheet.control_l28.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_i29; assert_equal("No effort to shift from road to rail, it is estimated that, by 2050  freight share between rail and road is 23 % of rail and the rest 77 % is road. ", worksheet.control_i29.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_j29; assert_equal("By 2050, a shift from road to rail reach ratio 32% by rail and road 68%", worksheet.control_j29.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_k29; assert_equal("Rationalization in the tariff regime of railway freight transport, coupled with increased speeds and a shift to 1435 gauge railway infrastrucure... the  railways freight reach 40% and the rest 60% of road by 2050.", worksheet.control_k29.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_l29; assert_equal("By 2050 infrastructure of railway will be improved strongly, mainly 1,000 mm gauge rail will be replaced by 1435 mm gauge rail....  55% surface freight transported by road and 45% by rail. ", worksheet.control_l29.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_i30; assert_equal("During 2015-2050, share of SWH remains 2.8%  as in 2010", worksheet.control_i30.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_j30; assert_equal("In 2050, share of SWH is 20% of total residential water heater", worksheet.control_j30.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_k30; assert_equal("In 2050, share of SWH is 30% of total residential water heater", worksheet.control_k30.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_l30; assert_equal("In 2050, share of SWH is 50% of total residential water heater, equivalent to 800,000 sets", worksheet.control_l30.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_i31; assert_equal("During 2011-2050 the lighting technology mix remains the same as in 2010. There is no LED or T5 in the home", worksheet.control_i31.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_j31; assert_equal("ICD is removed since 2015 per requested from the Government, also replaced by LED and CFL and a small part of T10 is replaced by T8, T5 and LED", worksheet.control_j31.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_k31; assert_equal("In 2050, a better mix of lighting technology is assumed. Of which, LED and T5 contributes the most ; but CFL and T8 is still in-use", worksheet.control_k31.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_l31; assert_equal("In 2050, whole residential lighting demand is  covered by LED and T5 only; CFL and T8 is no longer in-use.", worksheet.control_l31.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_i33; assert_equal("Biomass, Coal and Kerosene decrease year by year. In 2050, Gas contributes over 72%  , while Power and Biogass accounts for around 22% and 1.2% of useful energy for cooking", worksheet.control_i33.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_j33; assert_equal("A small switch on cooking technology : in 2050, Power increases by 31% , Gas declines by 52% and Biogas increases by 12% of useful energy for cooking.", worksheet.control_j33.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_k33; assert_equal("Power contributes 60% of useful energy for cooking in 2050, while Gas does 23%", worksheet.control_k33.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_l33; assert_equal("Coal and Kerosene are no longer in use after 2020. Power constributes 70% of useful energy for cooking in 2050, while Gas does 13%", worksheet.control_l33.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_i34; assert_equal("During 2010-2050, 5% of Electric stoves are Electric induction hobs", worksheet.control_i34.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_j34; assert_equal("Electric hop increases by 85% in 2050", worksheet.control_j34.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_k34; assert_equal("There is no conventional Electric stove beyond 2040", worksheet.control_k34.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_l34; assert_equal("There is no conventional Electric stove beyond 2030", worksheet.control_l34.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_i35; assert_equal("During 2010-2050, 2-4% of biomass stoves are improved ones", worksheet.control_i35.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_j35; assert_equal("Improved biomass stove increases by 30% in 2025 and remains beyond that time", worksheet.control_j35.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_k35; assert_equal("Improved biomass stove increases by 55% in 2050", worksheet.control_k35.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_l35; assert_equal("Improved biogass stove increases by 100% in 2050", worksheet.control_l35.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_i36; assert_equal("Share of EE home appliance increases from 0% in 2010 and 15% in 2050", worksheet.control_i36.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_j36; assert_equal("Share of EE home appliance increases to 15% in 2015 and 50% in 2050", worksheet.control_j36.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_k36; assert_equal("Share of EE home appliance increases to 15% in 2015 and 80% in 2050", worksheet.control_k36.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_l36; assert_equal("Share of EE home appliance increases to 15% in 2015 and 100% in 2040", worksheet.control_l36.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_i38; assert_equal("This trajectory, as base case, is used to forecast industrial energy use", worksheet.control_i38.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_j38; assert_equal("After 2015 industrial growth rates is just 85% of expected under trajectory A ", worksheet.control_j38.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_k38; assert_equal("After 2015 industrial growth rates is just 80% of expected under trajectory A ", worksheet.control_k38.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_i39; assert_equal("There is no more effort (no action, no plan) to improve industrial energy efficiency", worksheet.control_i39.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_j39; assert_equal("Industrial energy intensity declines by 10% in2015 and by 18% in 2050", worksheet.control_j39.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_k39; assert_equal("Industrial energy intensity declines by 10% in2015 and by 25% in 2050", worksheet.control_k39.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_l39; assert_equal("Industrial energy intensity declines by 10% in2015 and by 35% in 2050", worksheet.control_l39.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_i40; assert_equal("No improvement in the technology and no  improvement in insulation of builiding cover. Maintainance and control remains as it is in 2010", worksheet.control_i40.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_j40; assert_equal("40% saving potential are exploited by 2050 through AC system upgradation and improved maintainance and control", worksheet.control_j40.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_k40; assert_equal("70% saving potential are exploited by 2050 through AC system upgradation and improved maintainance and control", worksheet.control_k40.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_l40; assert_equal("Max penetration level - improved insulation and upgraded AC system  and improved maintainance and control", worksheet.control_l40.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_i41; assert_equal("Building occupancy improve, more decoration lighting hower energy saving measures are not applied", worksheet.control_i41.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_j41; assert_equal("40% saving potential are exploited by 2050 bringing about a reduction of 12.4% of energy consumption by 2050", worksheet.control_j41.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_k41; assert_equal("70% saving potential are exploited by 2050 bringing about a reduction of 22% of energy consumption by 2050", worksheet.control_k41.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_l41; assert_equal("100% saving potential are exploited by 2050 bringing about a reduction of 31% of energy consumption by 2050", worksheet.control_l41.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_i42; assert_equal("Public lighting are improved hower, current technologies remain. As a results, its energy consumption increases on average 6.7% during 2011-2050", worksheet.control_i42.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_j42; assert_equal("Mecury vapour lamps are replaced with higher EE sodium. LED are gradually adopted. ", worksheet.control_j42.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_k42; assert_equal("More aggress deployment of LED in replacement of Mecury vapour and Sodium lamps", worksheet.control_k42.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_l42; assert_equal("LED are fully deployed. In some places, LED for public lighting are developed with solar PV as power source", worksheet.control_l42.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_i43; assert_equal("Energy intensity during 2011-2050 remains as it was in 2010. Share of electricity increases from 34% in 2010 to 65.7% by 2050 to match with the revised forecast of the PDP 7 ", worksheet.control_i43.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_j43; assert_equal("10% improvemet of energy intensity by 2050 against the 2010 level. Shares of energy demand are same to the basecase", worksheet.control_j43.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_k43; assert_equal("20% improvemet of energy intensity by 2050 against the 2010 level. Shares of energy demand are same to the basecase", worksheet.control_k43.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_l43; assert_equal("30% improvemet of energy intensity by 2050 against the 2010 level. Shares of energy demand are same to the basecase", worksheet.control_l43.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_i44; assert_equal("Near-shore fishing remains common. Because near-shore seafood becomes increasingly scared, more diesel is required per ton of sea food. An increase of 20% by 2050 against the 2010 level is expected", worksheet.control_i44.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_j44; assert_equal("Off-the-coast fishing is deployed as planned. Bigger boats and with metal cover are increasingly used. Average diesel consumption per ton of seafood is assumed unchanged as it was in 2010", worksheet.control_j44.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_k44; assert_equal("More aggressive deplayment of Off-the-coast fishing with big boats and with metal cover. Diesel consumption per ton of seafood is assumed to reduce 10% by 2050 against the 2010 level.", worksheet.control_k44.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_l44; assert_equal("More aggressive deplayment of Off-the-coast fishing with big boats and metal cover. Solar PV and LED are being aggressively used", worksheet.control_l44.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_i45; assert_equal("Percentages of cultivation area being irrigated by water pump and mechandization level in land preparation and in havesting increase however, there is no EE improvement in those energy consumptions during 2011-2050", worksheet.control_i45.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_j45; assert_equal("Improvement in energy efficiency for water pumping and for preparation of land and havesting", worksheet.control_j45.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_k45; assert_equal("More improvement in energy efficiency for water pumping and for preparation of land and havesting", worksheet.control_k45.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_l45; assert_equal("Specific electricity consumption for water pumping reduces 35% by 2050 against the 2010 level. The improvement in energy consumption for land preparation and havesting improved by 20% and 25%, respectively.", worksheet.control_l45.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_i47; assert_equal("Development depends on the locations and costs. Therefore, it is assumed that development plans are not as expected.", worksheet.control_i47.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_j47; assert_equal("It is assumed that one unit will be commissioned in the period 2025-2030. Total capacity installed will be only 900 MW by 2050.", worksheet.control_j47.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_k47; assert_equal("It is assumed that one unit will be commissioned in the period 2025-2030. Total capacity installed will be only 1200 MW by 2050.", worksheet.control_k47.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_l47; assert_equal("It is assumed that there are 1500 MW installed by 2050.", worksheet.control_l47.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_i48; assert_equal("Low case scenario of Master Plan for coal; and oild & gas will be applied during period up to 2030. The period of 2031-2050 domestic fossil fuel supply will be at low growth rate.    ", worksheet.control_i48.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_j48; assert_equal("Base case scenario of Master Plan for coal; and oild & gas will be applied during period up to 2030. The period of 2031-2050 domestic fossil fuel supply will also be at low growth rate.  ", worksheet.control_j48.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_k48; assert_equal("High case scenario of Master Plan for coal; and oild & gas will be applied during period up to 2030. The period of 2031-2050 domestic fossil fuel supply will also be at low growth rate.  ", worksheet.control_k48.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_n4; assert_equal("All at level 1", worksheet.control_n4.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_o4; assert_equal("All at level 2", worksheet.control_o4.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_p4; assert_equal("All at level 3", worksheet.control_p4.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_q4; assert_equal("All at level 4", worksheet.control_q4.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_r4; assert_equal("Advanced coal power technology", worksheet.control_r4.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_s4; assert_equal("Higher energy efficiency", worksheet.control_s4.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_t4; assert_equal("Maximum effort from Transport", worksheet.control_t4.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_u4; assert_equal("Maximum renewable energy", worksheet.control_u4.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_control_n49; assert_equal("Fail to implement strategies and plans ", worksheet.control_n49.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_o49; assert_equal("Strategies and plan implementation as planned", worksheet.control_o49.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_p49; assert_equal("More efforts", worksheet.control_p49.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_q49; assert_equal("Maximum efforts both demand and supply", worksheet.control_q49.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_r49; assert_equal("Improve coal supply security", worksheet.control_r49.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_s49; assert_equal("Demand side management", worksheet.control_s49.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_t49; assert_equal("Energy efficiency and GHG reduction in the transport sector", worksheet.control_t49.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_u49; assert_equal("Renewable energy development", worksheet.control_u49.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_control_d5; assert_equal("Coal power station", worksheet.control_d5.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d6; assert_equal("Coal installed capacity", worksheet.control_d6.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d7; assert_equal("Coal technology", worksheet.control_d7.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d8; assert_equal("Carbon Capture Storage (CCS)", worksheet.control_d8.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d9; assert_equal("Nuclear power", worksheet.control_d9.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d10; assert_equal("Onshore wind", worksheet.control_d10.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d11; assert_equal("Offshore wind", worksheet.control_d11.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d12; assert_equal("Nearshore wind", worksheet.control_d12.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d13; assert_equal("Small hydro", worksheet.control_d13.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d14; assert_equal("Solar CSP", worksheet.control_d14.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d15; assert_equal("Geothermal electricity", worksheet.control_d15.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d16; assert_equal("Tidal electricity", worksheet.control_d16.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d17; assert_equal("Bioenergy electricity", worksheet.control_d17.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d18; assert_equal("Biomass", worksheet.control_d18.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d19; assert_equal("Biogas", worksheet.control_d19.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d20; assert_equal("Waste to energy", worksheet.control_d20.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d21; assert_equal("Solar PV", worksheet.control_d21.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d22; assert_equal("Electricity imports", worksheet.control_d22.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d24; assert_equal("Domestic passenger transport", worksheet.control_d24.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d25; assert_equal("Passenger transport demand", worksheet.control_d25.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d26; assert_equal("Shift to low emission passenger transport", worksheet.control_d26.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d27; assert_equal("Domestic freight", worksheet.control_d27.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d28; assert_equal("Freight transport demand", worksheet.control_d28.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d29; assert_equal("Shift to low emission freight transport", worksheet.control_d29.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d30; assert_equal("Domestic hot water", worksheet.control_d30.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d31; assert_equal("Domestic lighting", worksheet.control_d31.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d32; assert_equal("Domestic cooking", worksheet.control_d32.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d33; assert_equal("Cooking technology", worksheet.control_d33.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d34; assert_equal("Mix of Electric stoves", worksheet.control_d34.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d35; assert_equal("Mix of Biomass stoves", worksheet.control_d35.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d36; assert_equal("Domestic appliances and others", worksheet.control_d36.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d37; assert_equal("Industrial processes", worksheet.control_d37.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d38; assert_equal("Growth in industry", worksheet.control_d38.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d39; assert_equal("Energy intensity of industry", worksheet.control_d39.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d40; assert_equal("Commercial cooling", worksheet.control_d40.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d41; assert_equal("Commercial lighting", worksheet.control_d41.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d42; assert_equal("Public lighting", worksheet.control_d42.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d43; assert_equal("Commercial appliances, catering and others", worksheet.control_d43.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d44; assert_equal("Fishing", worksheet.control_d44.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d45; assert_equal("Irrigation and others", worksheet.control_d45.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d47; assert_equal("Pump storage hydro", worksheet.control_d47.to_s.gsub(/[\n\r]+/,'')); end
  def test_control_d48; assert_equal("Indigenous fossil-fuel production", worksheet.control_d48.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_control_g38; assert_equal("25.pdf", worksheet.control_g38.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_security_d36; assert_equal("Solar", worksheet.security_d36.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_security_d37; assert_equal("Wind", worksheet.security_d37.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_security_d38; assert_equal("Tidal", worksheet.security_d38.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_security_d39; assert_equal("Wave", worksheet.security_d39.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_security_d40; assert_equal("Geothermal", worksheet.security_d40.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_security_d41; assert_equal("Hydro", worksheet.security_d41.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_security_d42; assert_equal("Electricity oversupply (imports)", worksheet.security_d42.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_security_d43; assert_equal("Waste", worksheet.security_d43.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_security_d44; assert_equal("Agriculture", worksheet.security_d44.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_security_d45; assert_equal("Biomass oversupply (imports)", worksheet.security_d45.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_security_d46; assert_equal("Coal oversupply (imports)", worksheet.security_d46.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_security_d47; assert_equal("Coal reserves", worksheet.security_d47.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_security_d48; assert_equal("Oil reserves", worksheet.security_d48.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_security_d49; assert_equal("Oil and petroleum products oversupply (imports)", worksheet.security_d49.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_security_d50; assert_equal("Petroleum products oversupply", worksheet.security_d50.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_security_d51; assert_equal("Gas oversupply (imports)", worksheet.security_d51.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_electricity_d25; assert_equal("Transport", worksheet.electricity_d25.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_electricity_d26; assert_equal("Industry", worksheet.electricity_d26.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_electricity_d27; assert_equal("Resident", worksheet.electricity_d27.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_electricity_d28; assert_equal("Commerce", worksheet.electricity_d28.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_electricity_d29; assert_equal("Agriculture", worksheet.electricity_d29.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_electricity_d141; assert_equal("Fuel combustion", worksheet.electricity_d141.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_electricity_d64; assert_equal("Gas power stations", worksheet.electricity_d64.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_electricity_d65; assert_equal("Coal power stations", worksheet.electricity_d65.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_electricity_d66; assert_equal("Oi  power station", worksheet.electricity_d66.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_electricity_d67; assert_equal("Nuclear power generation", worksheet.electricity_d67.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_electricity_d68; assert_equal("Hydro power generation", worksheet.electricity_d68.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_electricity_d69; assert_equal("Renewable energy generation", worksheet.electricity_d69.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_electricity_d70; assert_equal("Electricity import", worksheet.electricity_d70.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_energy_d26; assert_equal("Transport", worksheet.energy_d26.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_energy_d27; assert_equal("Resident", worksheet.energy_d27.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_energy_d28; assert_equal("Commerce", worksheet.energy_d28.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_energy_d29; assert_equal("Industry", worksheet.energy_d29.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_energy_d30; assert_equal("Agriculture", worksheet.energy_d30.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_energy_d67; assert_equal("Domestic Gas", worksheet.energy_d67.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_energy_d68; assert_equal("Imported Gas", worksheet.energy_d68.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_energy_d69; assert_equal("Domestic Oil", worksheet.energy_d69.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_energy_d70; assert_equal("Imported Oil", worksheet.energy_d70.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_energy_d71; assert_equal("Domestic Coal", worksheet.energy_d71.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_energy_d72; assert_equal("Imported Coal", worksheet.energy_d72.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_energy_d73; assert_equal("Domestic Bioenergy", worksheet.energy_d73.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_energy_d74; assert_equal("Imported Bioenergy", worksheet.energy_d74.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_ghg_d6; assert_equal("Fuel Combustion", worksheet.ghg_d6.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_ghg_d7; assert_equal("Industrial Processes", worksheet.ghg_d7.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_ghg_d8; assert_equal("Agriculture", worksheet.ghg_d8.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_ghg_d9; assert_equal("Land Use, Land-Use Change and Forestry", worksheet.ghg_d9.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_ghg_d10; assert_equal("Waste", worksheet.ghg_d10.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_ghg_d11; assert_equal("Other", worksheet.ghg_d11.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_ghg_d12; assert_equal("Bioenergy credit", worksheet.ghg_d12.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_ghg_d13; assert_equal("Carbon capture", worksheet.ghg_d13.to_s.gsub(/[\n\r]+/,'')); end
  ...
  def test_ghg_d15; assert_equal("Baseline", worksheet.ghg_d15.to_s.gsub(/[\n\r]+/,'')); end
